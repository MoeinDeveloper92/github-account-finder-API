...
const User = () => {
    ...
    useEffect(() => {
        //we cannont make use effect async/ we need to create a function inside it as an async
                    ...
                    <div className="col-span-2">
                        <div className="mb-6">
                            ...
                            <div className="mt-4 card-actions">
                                <a className='btn btn-outline' href={html_url} target='_blank' rel='noreferrer'>Visit My Github Profile</a>
                            </div>
                        </div>
